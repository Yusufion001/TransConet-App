    ...
    >
      ...
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-brand-600 to-brand-700 overflow-hidden">
         ...
         <svg className="absolute bottom-0 w-full h-40" viewBox="0 0 400 150" preserveAspectRatio="none">
           <path d="M-50,150 Q150,150 200,100 T450,50" fill="none" stroke="var(--color-slate-700)" strokeWidth="40" strokeLinecap="round" />
         ...
         <div className="absolute bottom-6 right-[30%] transform translate-x-1/2 drop-shadow-2xl group-hover:-translate-y-1 transition-transform duration-75">
           <svg width="120" height="70" viewBox="0 0 120 70" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             {/* Trailer */}
             <rect x="2" y="10" width="80" height="45" rx="2" fill="var(--color-brand-600)" />
             <rect x="2" y="10" width="80" height="45" rx="2" fill="url(#trailer-grad)" />
             {/* Lines on trailer */}
             <line x1="20" y1="15" x2="20" y2="50" stroke="var(--color-brand-600)" strokeWidth="1.5" />
             <line x1="40" y1="15" x2="40" y2="50" stroke="var(--color-brand-600)" strokeWidth="1.5" />
             <line x1="60" y1="15" x2="60" y2="50" stroke="var(--color-brand-600)" strokeWidth="1.5" />
             {/* Cab */}
             <path d="M84 25H105C108.314 25 111.455 26.5415 113.5 29L118 35V55H84V25Z" fill="var(--color-slate-50)" />
             <path d="M84 25H105C108.314 25 111.455 26.5415 113.5 29L118 35V55H84V25Z" fill="url(#cab-grad)" />
             {/* Window */}
             <path d="M88 28H103C105.209 28 107.288 29.136 108.5 31L111 35H88V28Z" fill="var(--color-slate-900)" />
             {/* Grill */}
             <rect x="115" y="40" width="3" height="10" fill="var(--color-slate-400)" />
             <rect x="115" y="43" width="4" height="2" fill="#F59E0B" />
             {/* Connector */}
             <rect x="80" y="45" width="4" height="4" fill="var(--color-slate-700)" />
             {/* Wheels */}
             <circle cx="20" cy="55" r="8" fill="var(--color-slate-900)" />
             <circle cx="20" cy="55" r="4" fill="var(--color-slate-400)" />
             <circle cx="40" cy="55" r="8" fill="var(--color-slate-900)" />
             <circle cx="40" cy="55" r="4" fill="var(--color-slate-400)" />
             <circle cx="95" cy="55" r="8" fill="var(--color-slate-900)" />
             <circle cx="95" cy="55" r="4" fill="var(--color-slate-400)" />
             <circle cx="110" cy="55" r="8" fill="var(--color-slate-900)" />
             <circle cx="110" cy="55" r="4" fill="var(--color-slate-400)" />
             <defs>
      ...
      <div className="absolute right-6 md:right-12 top-6 z-10 flex flex-col items-center">
         <div className="w-14 h-14 bg-brand-600 text-white rounded-full flex items-center justify-center shadow-2xl shadow-brand-900 animate-bounce border-4 border-slate-900">
