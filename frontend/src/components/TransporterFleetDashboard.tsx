        ...
        {activeTab === 'overview' && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                <p className="text-xs text-slate-500 dark:text-slate- font-bold uppercase tracking-wider mb-1">Active Trips</p>
                <div className="flex items-end justify-between">
                  <h3 className="text-2xl font-black text-slate-800 dark:text-slate-">8</h3>
              ...
              <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                <p className="text-xs text-slate-500 dark:text-slate- font-bold uppercase tracking-wider mb-1">Maint. Alerts</p>
                <div className="flex items-end justify-between">
                  <h3 className="text-2xl font-black text-slate-800 dark:text-slate-">2</h3>
            ...
            {/* Earnings Chart */}
            <div className="bg-white dark:bg-slate-900 p-5 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h3 className="text-lg font-bold text-slate-800 dark:text-slate-">Revenue Analytics</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-">Weekly performance</p>
                </div>
              ...
              <div className="flex justify-between text-xs text-slate-500 dark:text-slate- font-bold uppercase mt-4 px-2">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead className="bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate- font-bold text-xs uppercase tracking-wider">
                    <tr>
        ...
        {activeTab === 'drivers' && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {drivers.map(driver => (
                <div key={driver.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm hover:shadow-md transition">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate- font-bold">
                        {driver.name.charAt(0)}
                      </div>
                      <div>
                        <h4 className="font-bold text-slate-800 dark:text-slate-">{driver.name}</h4>
                        <p className="text-xs text-slate-500 dark:text-slate- font-mono">{driver.id}</p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                     <div>
                       <p className="text-[10px] text-slate-500 dark:text-slate- font-bold uppercase tracking-wider">Rating</p>
                       <p className="font-bold text-slate-800 dark:text-slate- flex items-center gap-1 text-sm"><Star size={14} className="text-amber-400 fill-amber-400"/> {driver.rating}</p>
                     </div>
                     <div>
                       <p className="text-[10px] text-slate-500 dark:text-slate- font-bold uppercase tracking-wider">Trips</p>
                       <p className="font-bold text-slate-800 dark:text-slate- text-sm">{driver.trips}</p>
                     </div>
                  </div>
                   ...
                   {[
                     ...
                     <div key={i} className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-brand-50 cursor-pointer hover:shadow-sm transition">
                       <div className="flex items-start gap-3">
                         ...
                         <div>
                           <h4 className="font-bold text-slate-800 dark:text-slate-">{log.type}</h4>
                           <p className="text-sm text-slate-500 dark:text-slate-">Truck: <span className="font-mono font-bold text-slate-700 dark:text-slate-">{log.truck}</span></p>
