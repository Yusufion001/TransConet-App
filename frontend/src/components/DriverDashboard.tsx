    ...
    <div className="w-full h-full flex flex-col bg-slate-50">
      ...
      <div className="p-4 md:p-6 pb-32 space-y-4 max-w-lg mx-auto w-full">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Ready for your next trip.</p>
          </div>
          <Button 
            ...
            <Button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold whitespace-nowrap transition-all ${
                activeTab === tab.id 
                  ...
                  : 'bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 opacity-100'
              }`}
            >
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 max-w-lg mx-auto w-full">
            ...
            {availableJobs.length === 0 ? (
              ...
              <div key={job.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-5 rounded-[20px] shadow-sm overflow-hidden">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <h3 className="font-black text-lg text-slate-800 dark:text-slate-400">₦{(job.suggestedBudget || 0).toLocaleString()}</h3>
                </div>
                ...
                <div className="space-y-3 mb-6 relative">
                  ...
                  <div className="flex gap-3 relative z-10">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-slate-800 dark:text-slate-400 text-sm">{job.origin}</p>
                    </div>
                  </div>
                  <div className="flex gap-3 relative z-10">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-slate-800 dark:text-slate-400 text-sm">{job.destination}</p>
                    </div>
                  </div>
                </div>
        ...
        {activeTab === 'active-trip' && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <div className="bg-slate-800 text-white p-5 rounded-[20px] relative overflow-hidden shadow-xl shadow-slate-900/20">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-5 rounded-[20px] shadow-sm overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                 ...
                 <Button className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-4 rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-600 transition group text-slate-600 dark:text-slate-400">
        ...
        {activeTab === 'earnings' && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
             <div className="bg-brand-600 p-6 rounded-[20px] text-white shadow-xl shadow-blue-900/20 relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <div className="mt-6 pt-6 border-t border-brand-500/30 flex justify-between items-center">
                    ...
                    <Button className="bg-white dark:bg-slate-900 text-brand-700 px-5 py-2.5 rounded-full font-bold text-sm shadow-sm hover:scale-105 transition-transform">
                      Withdraw
                    </Button>
                  </div>
                </div>
             ...
             <h3 className="font-bold text-slate-800 dark:text-slate-400 px-1 mt-6 mb-3">Recent Transactions</h3>
                ...
                {[
                  ...
                  <div key={i} className="p-4 border-b border-slate-100 dark:border-slate-800 last:border-0 flex justify-between items-center hover:bg-brand-50 cursor-pointer hover:shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-slate-800 dark:text-slate-400 text-sm">{txn.desc}</p>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-800 rounded-xl">
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                           <p className="font-bold text-slate-800 dark:text-slate-400 text-sm">{doc.title}</p>
