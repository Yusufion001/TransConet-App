...
async function startServer() {
  ...
  app.use(cors({
    origin: function (origin, callback) {
      if (!origin || allowedOrigins.includes(origin) || origin.endsWith('.run.app') || origin.endsWith('.cloudshell.dev') || origin.endsWith('.railway.app') || origin.includes('railway') || origin.endsWith('.onrender.com') || origin.includes('onrender') || origin.endsWith('.vercel.app') || origin.includes('vercel')) {
        callback(null, true);
      } else {
