...
async function startServer() {
  ...
  app.use(cors({
    origin: (origin, callback) => {
      if (!origin || allowedOrigins.includes(origin) || origin.endsWith('.onrender.com') || origin.includes('onrender') || origin.endsWith('.vercel.app') || origin.includes('vercel')) callback(null, true);
