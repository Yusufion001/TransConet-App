...
export const AdminBrandConsole = () => (
  <div className="bg-blue-600 border border-blue-500 rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-xl ">
    <div className="absolute top-0 right-0 p-8 opacity-10">
      <Cpu size={160} className="text-white" />
    </div>
    
    <div className="relative space-y-4">
      <div className="inline-flex items-center gap-1.5 bg-blue-700 text-white text-xs font-bold px-3 py-1 rounded-full border border-blue-500 uppercase tracking-wider">
